...
export class ProductsService {
  ...
  async updateProduct(productId: string, tenantId: string, data: z.infer<typeof updateProductSchema>) {
    try {
  ...
  async searchProducts(query: { category?: string; tenantId?: string; search?: string }) {
