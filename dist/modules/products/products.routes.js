...
router.post('/', requireAuth, requireRoles(['SUPPLIER_OWNER', 'SUPPLIER_STAFF']), requireTenant, productsController.createProduct);
router.patch('/:id', requireAuth, requireRoles(['SUPPLIER_OWNER', 'SUPPLIER_STAFF']), requireTenant, productsController.updateProduct);
